...
if (!empty($category_filter)) {
    $products = getProductsByCategory($pdo, $category_filter);
...
<head>
    ...
    <title><?php echo $page_title; ?> - KITKIT Shopping</title>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-16">
                ...
                <nav class="hidden md:flex items-center space-x-8">
                    ...
                    <a href="product_categories.php" class="text-primary font-medium">Categories</a>
    ...
    <section class="bg-gradient-to-br from-primary-50 to-secondary-50 py-12">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center">
                <h1 class="text-4xl md:text-5xl font-bold text-primary mb-4"><?php echo $page_title; ?></h1>
                <p class="text-xl text-neutral-600 max-w-2xl mx-auto">
                    Discover fresh, quality products from trusted suppliers
                </p>
            </div>
        </div>
    </section>
    ...
    <section class="py-8 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex flex-wrap gap-4 justify-center">
                <a href="product_categories.php" class="px-4 py-2 bg-primary text-white rounded-full text-sm font-medium">All Categories</a>
                <?php foreach ($categories as $category): ?>
                <a href="product_categories.php?category=<?php echo urlencode($category['name']); ?>" class="px-4 py-2 bg-neutral-100 text-neutral-700 rounded-full text-sm font-medium hover:bg-primary hover:text-white transition-colors">
    ...
    <section class="py-16 bg-surface">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="text-center py-16">
                ...
                <p class="text-neutral-600 mb-4">Try browsing other categories</p>
                <a href="product_categories.php" class="btn-primary">View All Categories</a>
            </div>
            <?php endif; ?>
        </div>
    </section>
